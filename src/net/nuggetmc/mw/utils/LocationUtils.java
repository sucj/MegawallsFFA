...
public class LocationUtils {
    ...
    public static Vector getBackVector(final Location location) {
        final float f1 = (float) (location.getZ() + Math.sin(Math.toRadians(location.getYaw() + 90.0f)));
        final float f2 = (float) (location.getX() + Math.cos(Math.toRadians(location.getYaw() + 90.0f)));

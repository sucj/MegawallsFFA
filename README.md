...
在它作为一个服务器运行的时间里，大部分时间都跑在mc.huiwow.top上并半公开地作为一个hvh服务器存在着，玩家群体很小，不超过百人。
...
从技术角度评估，这个插件里面混杂的代码堪称古今中外，代码水平参差不齐，所以即使我近期作了重构的一次尝试，也认为这是没必要且困难的。

由于个人原因，我也无意再从事此类型项目的开发了。

综上所述，我遂决定开源。至少还有被再次发现的可能，即使它是微薄的；至少还能证明有一段时光确实存在过。
...
### 请尽量使用本项目已经上传在libs里的插件及服务端，否则可能会引发功能缺失或未知问题。
...
在那个还没有AI的时代，一个未来的文科生开动脑筋能想出这么猎奇的办法，我还是相当佩服我自己的。

## ”先人未竞之事业“（如果你真的读了本项目的代码并感到好奇的话）
